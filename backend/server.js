...
Format your response as structured JSON with clear sections for each category.`;
    ...
    const message = await anthropic.messages.create({
      ...
      max_tokens: 2048,
      temperature: 0.2,
      system: 'You are a sports statistics expert. Provide comprehensive, accurate sports matchup data in structured JSON format. Include team performance metrics, head-to-head history, recent form[...]',
      messages: [
        {
          role: 'user',
          content: prompt
